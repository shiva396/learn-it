...
class ConjunctionsPage extends StatefulWidget {
  ...
  @override
  _ConjunctionsPageState createState() => _ConjunctionsPageState();
}

class _ConjunctionsPageState extends State<ConjunctionsPage> {
  double _fontSize = 16;
  ...
  void initState() {
    ...
    RecentActivitiesService.logGrammarLearned('Conjunctions');
  }
          ...
          Expanded(
            child: FutureBuilder<String>(
              future: DefaultAssetBundle.of(
                context,
              ).loadString('assets/markdown/conjunctions.md'),
